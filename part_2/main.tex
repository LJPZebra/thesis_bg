...
\chapter{Results}
  ...
  \paragraph{Protocol} Fish chemical preference was assessed using Dual and a one-hour long experimental protocol, see Figure~{}. This protocol is subdivided into 4 cycles:
  ...
  \paragraph{Time-basec preference index} The preference index is a measure of the attraction or repulsion of a product. It is defined from the times spent inside or outside the product as follows:
  $$
